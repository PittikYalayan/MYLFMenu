...
local function newSection(parent,title)
    ...
    local t=Instance.new("TextLabel")
    t.BackgroundTransparency=1; t.Text=title; t.Font=Enum.Font.GothamBold; t.TextSize=14; t.TextColor3=CurrentTheme.Text
    t.Size=UDim2.new(1,0,0,18); t.Parent=s
...
local function makeRow(parent,label)
    ...
    l.TextColor3=CurrentTheme.SubText
...
function Controls.Slider(parent,label,min,max,default,fmt,callback)
    ...
    frame.Size=UDim2.new(0.52,0,0,24)
    frame.Position=UDim2.new(0.46,0,0.5,-12)
    frame.BackgroundColor3=CurrentTheme.Hover
    frame.Parent=row
    makeCorner(frame,6); makeStroke(frame,1,.15)
    local fill=Instance.new("Frame")
    fill.BackgroundColor3=CurrentTheme.Accent
    fill.Size=UDim2.new((default-min)/(max-min),0,1,0)
    fill.Parent=frame; makeCorner(fill,6)
    local valText=Instance.new("TextLabel")
    valText.BackgroundTransparency=1
    valText.TextColor3=CurrentTheme.Text
    valText.Font=Enum.Font.GothamSemibold
    valText.TextSize=12
    valText.Size=UDim2.new(0,60,1,0)
    valText.AnchorPoint=Vector2.new(1,0)
    valText.Position=UDim2.new(1,-6,0,0)
    valText.Parent=frame
    valText.Text=(fmt or "%d"):format(default)
...
local function createWaypoint(name,pos)
    ...
    bb.Adornee=att;bb.Size=UDim2.fromOffset(160,40);bb.AlwaysOnTop=true;bb.Parent=part
    local label=Instance.new("TextLabel")
    label.Size=UDim2.new(1,0,1,0);label.BackgroundTransparency=0.2
    label.BackgroundColor3=CurrentTheme.Panel;label.TextColor3=CurrentTheme.Text
    label.Font=Enum.Font.GothamBold;label.TextSize=14;label.Text="📍 "..name
