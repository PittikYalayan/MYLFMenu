...
flyBtn.MouseButton1Click:Connect(function()
    ...
    flyBtn.Text, flyBtn.BackgroundColor3 = flyEnabled and "️ Fly ON" or "️ Fly OFF", flyEnabled and Color3.fromRGB(0,200,100) or Color3.fromRGB(120,60,200)
    applyFly()
end)

uis.InputBegan:Connect(function(input,gp)
    if not gp and input.KeyCode == Enum.KeyCode.E then flyBtn:Activate() end
end)
...
tpBtn.MouseButton1Click:Connect(function()
    ...
    tpBtn.Text, tpBtn.BackgroundColor3 = tpEnabled and " Teleport Tool ON" or " Teleport Tool OFF", tpEnabled and Color3.fromRGB(0,200,100) or Color3.fromRGB(150,100,200)
    spawn(function()
        while tpEnabled do
